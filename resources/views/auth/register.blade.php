                ...
                <div class="col-md-12">
                    <div class="form-block mx-auto">
                        <div class="text-center mb-5">
                            <h3 class="text-uppercase"> <strong>Đăng Ký</strong></h3>
                        ...
                        <form action="{{route('register')}}" method="POST">
                            ...
                            <div class="form-group first">
                                ...
                                <input id="name" type="text" class="form-control" placeholder="name"  @error('name') is-invalid @enderror name="email" value="{{ old('name') }}" required autocomplete="name" autofocus>
                                @error('name')
