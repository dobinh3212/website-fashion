    ...
    <div class="container mega-main clearfix">
        ...
        <div class="row">
            <div class="col-md-9 col-md-push-3 col-sm-push-4 col-sm-8 wow bounceInLeft" data-wow-duration="2s">
                ...
                <p class="font-14  text-center mar-top-20">{!!$page ->summary !!}</p>
                ...
                <div class="line-full mar-bot-10"></div>
                <p ><img class="img-thumbnail img-responsive" width="100%" src="{{asset($page->image)}}" alt=""> </p>
                <blockquote>{!!$page ->description !!}</blockquote>
                <br>
                <br>
                <div class="line-full mar-bot-10"></div>
                <p><i class="fa fa-calendar" aria-hidden="true"></i> <span class="pink"> &nbsp;{{$page->created_at}}</span></p>
                <div class="clearfix"></div>
                <div class="line-full mar-bot-10"></div>
                <br>
                <br>
