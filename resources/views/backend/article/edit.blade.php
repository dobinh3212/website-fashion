...
@section('main-content')
    ...
    <div class="content">
        <div class="row">
            <!-- left column -->
            <form role="form" method="post" action="{{route('admin.article.update',$data->id)}} " enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="col-md-7">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input name="title" type="text" class="form-control"  id="title" value=" {{$data->title}} " placeholder="Nhập Tên Sản Phẩm">
                                @error('title')
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    <div class="form-group image ">
                                        ...
                                        <img id="avatar" class="thumbnail" width="300px" height="auto" src="{{asset($data->image)}}">
                ...
                <div class="col-md-5">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="summary" class="form-control" id="summary" cols="30" rows="5">{!! $data->summary!!}</textarea>
                    </div>
                    @error('summary')
                    <small class="form-text text-danger ">
                        {{$message}}
